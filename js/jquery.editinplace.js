...
$.fn.editInPlace.defaults = {
    ...
    save_button:        '<input type="image" src="images/icons/tick-button.png" width="16" height="16" style="border:none;" class="inplace_save" value="Save"/>',
    cancel_button:      '<input type="image" src="images/icons/delete_cross_square.png" width="16" height="16" style="border:none;" value="Cancel"/>',
