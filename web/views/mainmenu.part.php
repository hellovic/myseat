...
<div id="menu_wrapper">
	...
	<ul class="nav" style='margin-left:40px;'>
		...
		<?php endif ?>
		<li>
			<a href="http://<?= $_SERVER['HTTP_HOST'].substr(dirname($_SERVER['PHP_SELF']),0,-4);?>/contactform/index.php?so=ON&prp=<?= $_SESSION['propertyID'];?>&outletID=<?= $_SESSION['outletID'];?>" target="blank">Contact Form
			</a>
